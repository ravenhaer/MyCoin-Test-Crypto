...
def mine_block():
   ...
   blockchain.add_transaction( sender = node_address, receiver = 'Anwesha_virtual_pc', amount = 100)  #This transaction is the miner receiving reward coins. So sender is set to our(creator of that crypto) port addr.
...
#Running the App
app.run(host = '0.0.0.0', port = 5002)     #"app" object here and above is an instance of Flask class
