...
def mine_block():
   ...
   blockchain.add_transaction( sender = node_address, receiver = 'Anwesha', amount = 100)  #This transaction is the miner receiving reward coins. So sender is set to our(creator of that crypto) port addr.
